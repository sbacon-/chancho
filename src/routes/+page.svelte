...
<div style="width:{hex_alt*2}px; height:{hex_len*2}px;" class="m-auto text-center txt">
  <TownPortal {dark} {darkMode} {lightMode} {hex_len} adjust={h<w?0:(h/2-w/2)}/>
  <section style="height: {hex_len}px;">
    ...
    {:else if log_status == "auth"}
      ...
      <button onclick={sign_out} class="pri2-bg ui-button pri2-bord ui-border my-3 px-3" >logout</button>
    {/if}
  </section>
</div>
<script>
